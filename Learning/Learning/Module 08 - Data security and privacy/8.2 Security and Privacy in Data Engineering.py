...
# MAGIC %md
# MAGIC ## Follow Along
# MAGIC If you're having trouble with the exercise (or looking to see this demonstrated in a domain), check out the follow-along video:
# MAGIC
# MAGIC <div style={{textAlign: 'center'}} > 
# MAGIC <figure class="video-container">
# MAGIC     <iframe src="https://www.youtube.com/embed/Vnv9Tm2oD84" id="ytplayer"  allowtransparency="true" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen" mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="620" height="349"></iframe>
# MAGIC </figure>
# MAGIC
# MAGIC In Databricks you do not see the video: please visit the [original on youtube](https://www.youtube.com/embed/Vnv9Tm2oD84)
# MAGIC </div>
...
# MAGIC %md
# MAGIC ### Recommended Reading & Further Study 
# MAGIC
# MAGIC - [Practical Data Privacy](https://learning.oreilly.com/library/view/practical-data-privacy/9781098129453/) and [accompanying repository](https://github.com/kjam/practical-data-privacy)
# MAGIC - [Introduction to Anonymization via Differential Privacy](https://desfontain.es/privacy/friendly-intro-to-differential-privacy.html)
# MAGIC - [OpenMined: Foundations of Private Computation](https://courses.openmined.org/courses/foundations-of-private-computation) 
...
# MAGIC |--------------------------------------------------------|------------------------------------------------------------------------------------------------------|
# MAGIC | <a href="$./8.1 Intro" target="_self">Introduction</a> | <a href="$./8.3 Socially-Responsible-ML" target="_self">Socially-Responsible-ML</a>                  |
# MAGIC
