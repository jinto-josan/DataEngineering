...
# MAGIC
# MAGIC 1. Click the `+` button next to the display `Table`. Make sure that you have run the code to display the dataframe before trying this please.
# MAGIC
...
# MAGIC Outside of Databricks, there are many other visualisation tools. One of the more customisable ones is called Plotly. Before we get started on the exercise, we'll quickly review [Plotly](https://plotly.com/). Some examples from Plotly can be found [here](https://plotly.com/python/getting-started/)
...
# MAGIC %md
# MAGIC ## Advanced Topic: Dashboards
# MAGIC Everyone talks about Dashboards. It's possible to go beyond our singular visualisations and compile them into a dashboard for someone to read. There are a variety of tools that exist, such as **Dash**, which works great with **Plotly**, and [**StreamLit**](https://streamlit.io/).
# MAGIC
...
# MAGIC |---------------------------------------------------------|-----------------------------------------------------------------|
# MAGIC | <a href="$./6.1 Intro" target="_self">Introduction</a>  | <a href="$./6.3 Accessibility" target="_self">Accessibility</a> |
# MAGIC
