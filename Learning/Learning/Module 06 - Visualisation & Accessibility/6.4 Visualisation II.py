...
# MAGIC %md
# MAGIC ## A list of visualization libraries
# MAGIC
# MAGIC Here is a list of some popular visualization libraries and the preferred one (Plotly) for your reference. 
# MAGIC
# MAGIC - [PG walker](https://kanaries.net/pygwalker$0) Fast with Tableau like interface.
# MAGIC - [Matplotlib](https://github.com/matplotlib/matplotlib$) Old time but a lot of new tricks up the sleeves. 
# MAGIC - [Plotly](https://github.com/plotly/plotly.py) Popular and preferred. Good starting point.
# MAGIC - [Seaborn](https://github.com/mwaskom/seaborn) Statistical powerhouse
# MAGIC - [Bokeh](https://github.com/bokeh/bokeh) A real time API for dynamic updates to the dashboards.
# MAGIC - [Altair](https://github.com/vega/altair) A go to library for academics.
# MAGIC
# MAGIC The above information is taken from [this](https://open-data-analytics.medium.com/top-python-data-visualization-libraries-of-2025-a28ec518dfae$0) link which can be referred for more information
# MAGIC
...
# MAGIC Let's visualise some data using different visualisation libraries in Python!
...
# MAGIC %pip install pandas s3fs plotly scikit-learn dash wget
...
# MAGIC |-----------------------------------------------------------------|-----------------------------------------------------------------------------------------|
# MAGIC | <a href="$./6.3 Accessibility" target="_self">Accessibility</a> | <a href="$../Module 07 - Streaming/7.0 Table of Contents" target="_self">Streaming</a> |
# MAGIC
