...
# MAGIC
# MAGIC Databricks is a cloud-first environment where Data Analysts, Data Scientists, and Data Engineers can collaborate and run **fully-managed Apache Spark** on the cloud.<br>
# MAGIC
...
# MAGIC * Use DBUtils and some common functions
# MAGIC * Create the SparkSession and use it to interact with Spark
# MAGIC * PySpark SQL Functions and DataFrames and casting functions
# MAGIC * Use Pandas to create your own DataFrames
# MAGIC
...
# MAGIC - For more info go to [**DBUtils Official Documentation**](https://docs.databricks.com/dev-tools/databricks-utils.html)
...
# MAGIC
# MAGIC In this example we're using an example dataset containing 20k random Amazon reviews that we can play around with.
...
# MAGIC
# MAGIC Let's see how we can create DataFrames from scratch using some data we provide ourselves, too.
...
# MAGIC %md
# MAGIC 💡 [Collect the data from a DataFrame](https://sparkbyexamples.com/pyspark/pyspark-collect/)
...
# MAGIC |-----------------------------------------------------------------------------|-------------------------------------------------------------------|
# MAGIC | <a href="$./2.3 Apache Spark Primer" target="_self">Apache Spark Primer</a> | <a href="$../Module 03 - Data Ingestion and Basic Transformations/3.0 Table of Contents" target="_self">Data Ingestion and Basic Transformations</a> |
